...
$(document).ready(function(e) {
    ...
    $('.art-vmenu a').each(function() {
        if (location.pathname.indexOf($(this).attr('href')) > -1) {
            $('.art-vmenu a').removeClass('active');
            $('.art-vmenu a').parent().removeClass('active');
...
$('.art-vmenu a').click(function() {
    alert($(this).attr('href'));
    $(this).addClass('active');
    $(this).parentNode('li').addClass('active');
    ...
    $('input[name$=TxtPass]').blur(function() {
        ...
        var userPass = $('input[name$=TxtPass]').val();
        //

        $.post(
            'CustomerLogin.aspx',
            { ctl00$ContentPlaceHolder1$TxtUser: userName, ctl00$ContentPlaceHolder1$TxtPass: userPass },
            function(data) {
                $('body').html(data);
            });
