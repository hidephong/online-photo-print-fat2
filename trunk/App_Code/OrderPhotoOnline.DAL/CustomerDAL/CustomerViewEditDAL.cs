...
/// <summary>
/// Summary description for CustomerViewEditDAL
/// </summary>
public class CustomerViewEditDAL
{
    SqlConnection con;
	public CustomerViewEditDAL()
	{
		//
		// TODO: Add constructor logic here
		//
	}
    public DataTable getCustomerByUsername(string us)
    {
       
        SqlParameter[] paramList = new SqlParameter[1];
        paramList[0] = new SqlParameter("@user", us);
        con = new SqlConnection(ConfigurationManager.ConnectionStrings["OODPPConnectionString"].ConnectionString);
        con.Open();
        SqlDataAdapter adt = new SqlDataAdapter("getCustomerByID", con);
    ...
    public int UpdateCustomer(Customer cu)
    {
        ...
        paramList[10] = new SqlParameter("@Status", "");
        con = new SqlConnection(ConfigurationManager.ConnectionStrings["OODPPConnectionString"].ConnectionString);
        con.Open();
