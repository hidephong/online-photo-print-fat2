...
public partial class OrderPhotoPL_Admin_AddUser : System.Web.UI.Page
{
    ...
    {
        addUserBLL au = new addUserBLL();
        bool bl= au.AddUser(txtName.Text, txtUsername.Text, txtPassword.Text, txtAddress.Text, DateTime.Parse(txtDOB.Text), txtEmail.Text);
